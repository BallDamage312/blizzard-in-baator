...
IF~CheckStatGT(Protagonist,18,WIS)~THEN REPLY @14 /*Detach yourself from the sensation while it is still possible. */ DO~~ EXIT
...
IF~CheckStatLT(Protagonist,19,WIS)~THEN REPLY @20 /*Keep trying to detach... 
...
IF~CheckStatGT(Protagonist,19,WIS)~THEN REPLY @39 /*Try to detach yourself from the sensation. */ DO~~ EXIT
IF~CheckStatLT(Protagonist,20,WIS)~THEN REPLY @40 /*Try to detach yourself from the sensation. */ DO~~ + g-bbD222.noexit
...
IF~CheckStatGT(Protagonist,20,WIS)~THEN REPLY @45 /*Try to detach yourself from the sensation. */ DO~~ EXIT
IF~CheckStatLT(Protagonist,21,WIS)~THEN REPLY @46 /*Try to detach yourself from the sensation. */ DO~~ + g-bbD222.noexit
...
IF~CheckStatGT(Protagonist,21,WIS)~THEN REPLY @51 /*Try to detach yourself from the sensation. */ DO~~ EXIT
IF~CheckStatLT(Protagonist,22,WIS)~THEN REPLY @52 /*Try to detach yourself from the sensation. */ DO~~ + g-bbD222.noexit
...
IF~CheckStatGT(Protagonist,22,WIS)~THEN REPLY @57 /*Try to detach yourself from the sensation. */ DO~~ EXIT
IF~CheckStatLT(Protagonist,23,WIS)~THEN REPLY @58 /*Try to detach yourself from the sensation. */ DO~~ + g-bbD222.noexit
...
IF~CheckStatGT(Protagonist,23,WIS)~THEN REPLY @63 /*Try to detach yourself from the sensation. */ DO~~ EXIT
IF~CheckStatLT(Protagonist,24,WIS)~THEN REPLY @64 /*Try to detach yourself from the sensation. */ DO~~ + g-bbD222.noexit
...
IF~CheckStatGT(Protagonist,24,WIS)~THEN REPLY @70 /*Try to detach yourself from the sensation. */ DO~~ EXIT
IF~CheckStatLT(Protagonist,25,WIS)~THEN REPLY @71 /*Try to detach yourself from the sensation. */ DO~~ + g-bbD222.noexit
...
=@75 /*^0xff8c6b69You did it. The idea was crazy, impossible, but... you did it. Once upon a time, you would have welcomed this success with joy. Later, you would have called it routine. Now, however, it is nothing more than picking at old yet still painful wounds.^- */
...
IF~CheckStatGT(Protagonist,24,WIS)~THEN REPLY @80 /*Try to detach yourself from the sensation. */ DO~~ EXIT
IF~CheckStatLT(Protagonist,25,WIS)~THEN REPLY @81 /*Try to detach yourself from the sensation. */ DO~~ + g-bbD222.noexit
...
IF~CheckStatGT(Protagonist,18,WIS)~THEN REPLY @90 /*Try to change the past. Maybe changing the memory is the key? */ DO~~ + g-bbD222.over2
IF~CheckStatGT(Protagonist,24,WIS)~THEN REPLY @91 /*Try to detach yourself from the sensation. */ DO~~ EXIT
IF~CheckStatLT(Protagonist,25,WIS)~THEN REPLY @92 /*Try to detach yourself from the sensation. */ DO~~ + g-bbD222.noexit
...
IF~CheckStatGT(Protagonist,18,WIS)~THEN REPLY @103 /*Try to change the past still. Maybe changing the memory is the key? */ DO~~ + g-bbD222.over2
IF~CheckStatGT(Protagonist,24,WIS)~THEN REPLY @104 /*Try to detach yourself from the sensation. */ DO~~ EXIT
IF~CheckStatLT(Protagonist,25,WIS)~THEN REPLY @105 /*Try to detach yourself from the sensation. */ DO~~ + g-bbD222.noexit
