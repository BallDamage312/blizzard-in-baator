BEGIN g-bbD045
CHAIN IF~Global("G-beach","GLOBAL",0)~THEN g-bbD045 g-bbD045.start
...
END
IF~CheckStatGT(Protagonist,18,CHR)~THEN REPLY @8 /*"Ladies..." */ DO~SetGlobal("G-beach","GLOBAL",1)~ + g-bbD045.partytime
IF~!CheckStatGT(Protagonist,18,CHR)
!CheckStatLT(Protagonist,12,CHR)~THEN REPLY @9 /*"Greetings..." */ DO~SetGlobal("G-beach","GLOBAL",2)~ + g-bbD045.neutral
IF~CheckStatLT(Protagonist,12,CHR)~THEN REPLY @10 /*"Uhh... hello..." */ DO~SetGlobal("G-beach","GLOBAL",3)~ + g-bbD045.scare
CHAIN IF~~THEN g-bbD045 g-bbD045.scare
...
CHAIN IF~~THEN g-bbD045 g-bbD045.neutral
...
END
IF~~THEN REPLY @22 /*"Hello, ladies. Who are you?" */ DO~~ + g-bbD045.A1
IF~~THEN REPLY @23 /*"No. Farewell." */ DO~~ EXIT
CHAIN IF~~THEN g-bbD045 g-bbD045.partytime
...
END
IF~~THEN REPLY @29 /*"Hello, beautiful ladies. May I ask your names?" */ DO~~ + g-bbD045.E1
IF~~THEN REPLY @30 /*"No, thank you. Goodbye." */ DO~~ EXIT
CHAIN IF~~THEN g-bbD045 g-bbD045.A1
...
END
IF~~THEN REPLY @34 /*"But I just wanted to ask a few questions!" */ DO~~ + g-bbD045.C1
IF~~THEN REPLY @35 /*"Well. Have fun." */ DO~~ EXIT
CHAIN IF~Global("G-beach","GLOBAL",2)~THEN g-bbD045 g-bbD045.C1
...
EXIT
CHAIN IF~~THEN g-bbD045 g-bbD045.E1
...
CHAIN IF~Global("G-beach","GLOBAL",1) Global("G-beachest","GLOBAL",1)~THEN g-bbD045 g-bbD045.G1
...
CHAIN IF~Global("G-beach","GLOBAL",1) Global("G-beachest","GLOBAL",0)~THEN g-bbD045 g-bbD045.H1
