BEGIN g-bbD056
CHAIN IF~NumTimesTalkedTo(0) !Dead("g-bb055") Global("g-sonnelefbehind","GLOBAL",0)~THEN g-bbD056 g-bbD056.start1
...
CHAIN IF~NumTimesTalkedToGT(0) !Dead("g-bb055") !Global("g-lovers4","GLOBAL",1) Global("g-sonnelefbehind","GLOBAL",0)~THEN g-bbD056 g-bbD056.start2
...
CHAIN IF~Global("g-sonnelefbehind","GLOBAL",1) OR(2) Global("g-lovers4","GLOBAL",1) GlobalGT("g-lovers","GLOBAL",0)~THEN g-bbD056 g-bbD056.start3
