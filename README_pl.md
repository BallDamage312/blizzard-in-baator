# Blizzard in Baator – modyfikacja do gry Planescape: Torment: Enhanced Edition
...
<b>Ważne</b>: Gra Planescape: Torment: Enhanced Edition zawiera od dawna występujący, nieusunięty błąd (tzw. „Modron Maze Bug”): każda wizyta w Labiryncie Modronów za pośrednictwem Kostki Modronów powoduje zresetowanie wszystkich pojemników, a czasami także obszarów i postaci. Jeśli planujesz odwiedzić Labirynt, zainstaluj darmowy mod [Generalized Biffing](https://github.com/Spellhold-Studios/Generalized-Biffing) od Spellhold Studios, aby naprawić bug. Jeśli nie zamierzasz używać Kostki lub grasz tylko w dodatek, nie będziesz go potrzebować.

<b>Linux</b>

Postępuj zgodnie z instrukcjami dla systemu Windows, z tą różnicą, że plik Setup-BlizzardInBaator.exe należy uruchomić za pomocą programu Wine.

<b>Mac</b>

Postępuj zgodnie z instrukcjami dla systemu Windows, z tą różnicą, że zamiast pliku .exe uruchom plik setup-blizzardinbaator.command.
